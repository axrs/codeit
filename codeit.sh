...
echo_message() {
    echo "${bldgrn}[codeit.sh]${txtrst} ${grn}$1${txtrst}"
}

echo_error() {
    echo "${bldred}[codeit.sh]${txtrst} ${red}$1${txtrst}"
}
...
reset() {
    ...
    db_drop_db "codeit_dev"
    db_drop_db "codeit_test"
    db_create_db "codeit_dev"
    db_create_db "codeit_test"
